from sqlalchemy import Enum as SQLEnum, Column, Integer, String, Float, DateTime, Boolean, UniqueConstraint
...
class FeedbackItem(Base):
    ...
    __table_args__ = (
        UniqueConstraint("filename", "client_source", name="uq_feedback_filename_source"),
    )
